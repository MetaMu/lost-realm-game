...
(function(root){
 ...
 Object.assign(K.TYPES,{
  lady:{name:'Lady Never Scared',title:'The Soul Gardener',power:'Healing · soul conversion',unlock:2,cost:320,color:'#afffe0',range:185,damage:0,interval:8.4,description:'Heals herself and nearby guardians for 4 HP/sec per level. Every 8.4 combat seconds, channels for 2 seconds to turn a non-boss mutant into an allied demon with 95% more health and attack damage, splashing nearby enemies for half damage. One active demon per Lady; demons never stop or slow enemies.'},
 ...
 class CampaignGame extends Base {
  ...
  target(t){if(t.type==='lady'&&this.hasSummon(t))return null;if(t.type==='lady')return this.enemies.find(e=>e.hp>0&&e.mutated&&e.kind!=='boss'&&!this.conversions.some(c=>c.target===e)&&dist(t,e)<=K.stats(t).range);if(t.type==='phil'&&this.shadowHits.length)return null;return super.target(t);}
  fire(t,e){
