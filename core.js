...
(function (root) {
  ...
  // Traced in source-art pixels (1536 x 1024), uniformly scaled to the 1200 x 800 board.
  const ASH_PATH = [[-25,147],[55,159],[125,191],[190,247],[233,315],[261,397],[284,480],[315,559],[352,613],[414,653],[489,683],[570,702],[655,711],[711,699],[763,665],[805,618],[844,548],[879,470],[913,391],[947,310],[991,243],[1042,199],[1100,178],[1167,173],[1225,183],[1275,207],[1306,242],[1335,286],[1366,321],[1418,349]].map(([x,y])=>[x/1.28,y/1.28]);
  const ASH_PADS = [[166,335],[345,310],[180,468],[406,430],[235,615],[438,586],[429,767],[592,791],[707,596],[845,725],[800,408],[1034,428],[865,251],[1110,284],[1226,334],[1153,520]].map(([x,y])=>[x/1.28,y/1.28]);
  const CITADEL_PATH = [[-25,410],[70,418],[162,424],[245,421],[302,400],[337,365],[358,313],[361,252],[355,200],[370,151],[405,111],[450,85],[493,78],[539,85],[581,111],[619,135],[666,147],[724,142],[788,127],[850,119],[903,126],[946,151],[976,190],[991,240],[994,289],[1005,327],[1038,363],[1073,398],[1096,436],[1103,481],[1098,532],[1104,576],[1130,612],[1172,638],[1221,646],[1273,639],[1315,620],[1354,590],[1385,557],[1424,538]].map(([x,y])=>[x/1.28,y/1.28]);
  const CITADEL_PADS = [[170,340],[267,298],[446,224],[549,207],[180,540],[1110,170],[1077,224],[1139,328],[960,424],[1216,445],[1000,588],[1215,552],[1320,514],[1287,721],[921,300],[428,493]].map(([x,y])=>[x/1.28,y/1.28]);
  ...
  function wavePlan(n,stage=1) {
    const baseCount = 7+n*2+(stage>=2?8:0), count = Math.round(baseCount*1.1), entries=[],venomWave=BALANCE.venomFirstWave[stage]||BALANCE.venomFirstWave[1];
